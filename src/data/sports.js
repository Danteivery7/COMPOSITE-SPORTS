...
export const SPORT_CONFIGS = {
  ...
  cbb: {
    ...
    introEyebrow: 'Court Lights',
    introTitle: 'Step Into The Arena',
    introCopy: 'The court lights rise, the banner wall wakes up, and the campus board opens straight onto hardwood instead of another floating-object tunnel.',
