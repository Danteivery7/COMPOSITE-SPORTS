...
export const SPORT_CONFIGS = {
  ...
  football: {
    ...
    cardBlurb: 'A full football hub with marquee matches, league selection, club boards, and International Play across the Premier League, La Liga, Serie A, Ligue 1, Bundesliga, MLS, Europe, and the world stage.',
    introEyebrow: 'Match-Night Lights',
    introTitle: 'Enter Composite Football',
    introCopy: 'Floodlights power on, the tifo rises, and the pitch lines cut in before you drop into the Premier League, La Liga, Serie A, Ligue 1, Bundesliga, MLS, Champions League, or International Play.',
