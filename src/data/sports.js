...
export const SPORT_CONFIGS = {
  ...
  cbb: {
    ...
    introCopy: 'Power conferences, mid-majors, bubble teams, and a six-source resume board rise through a bracket-reveal sequence before the campus board opens.',
